package com.example.composemovie.movie_detail.data.mapper_impl

import com.example.composemovie.common.data.ApiMapper
import com.example.composemovie.movie_detail.data.remote.models.CastDto
import com.example.composemovie.movie_detail.data.remote.models.MovieDetailDto
import com.example.composemovie.movie_detail.domain.models.Cast
...
class MovieDetailMapperImpl : ApiMapper<MovieDetail, MovieDetailDto> {
    override fun mapToDomain(apiDto: MovieDetailDto): MovieDetail {
        return MovieDetail(
            ...
            originalTitle = formatEmptyValue(apiDto.originalTitle, "originalTitle"),
            ...
            releaseDate = formatEmptyValue(apiDto.releaseDate, "releaseDate"),
